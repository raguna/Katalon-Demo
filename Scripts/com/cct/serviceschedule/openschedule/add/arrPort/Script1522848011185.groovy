...
CustomKeywords.'com.cct.util.Dropdownlist.selectDropdownlist'(findTestObject('com/cct/serviceschedule/openschedule/add/span_Arrival'), 
    findTestObject('com/cct/serviceschedule/openschedule/add/ul_ArrivalDeparture'), 1)
...
WebUI.verifyElementText(findTestObject('com/cct/serviceschedule/openschedule/add/input_autocompleteDepturePortN'), '')
