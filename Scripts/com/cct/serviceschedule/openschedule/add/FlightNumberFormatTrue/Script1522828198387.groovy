...
WebUI.click(findTestObject('com/cct/serviceschedule/openschedule/add/button_Open'))

CustomKeywords.'com.cct.util.Verify.notConTrainsText'(findTestObject('com/cct/serviceschedule/openschedule/add/alert message'), 
    result)
